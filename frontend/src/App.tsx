...
const PlanejamentoDashboard = lazy(
  () => import("@/pages/planejamento/index")
);
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          >
            ...
            <Route path="pagamentos" element={<EspecificadorPagamentosPage />} />
            <Route path="cronograma" element={<EspecificadorCronogramaPage />} />
          </Route>

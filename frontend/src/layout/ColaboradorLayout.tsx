 ...
 * Layout limpo e profissional para colaboradores internos
 */
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              <Link to="/colaborador" className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <div className="hidden sm:block text-left">
                      <p className="text-sm font-medium text-gray-900 truncate max-w-[120px]">
                        {usuarioCompleto?.nome?.split(" ")[0] || "Usuário"}
                      </p>
                      <p className="text-xs text-gray-500">
                        {usuarioCompleto?.cargo || "Colaborador"}
                      </p>
                    </div>
      ...
      <footer className="border-t border-gray-200 bg-white mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <p className="text-center text-sm text-gray-500">
            Portal do Colaborador WG &copy; {new Date().getFullYear()} - Grupo
            WG Almeida
          </p>
        </div>
      </footer>
